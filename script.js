    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שילת פרויקטים חכמים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2b77fa7f-2766-4560-a6cb-a4ca2f5aeffb',
                    name: data.name || '',
                    email: data.email || '',
